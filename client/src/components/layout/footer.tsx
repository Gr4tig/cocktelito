    ...
    <footer className="bg-[#0a0a0f] text-white py-16 border-t border-white/5">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="text-zinc-500 text-sm leading-relaxed">
              Elevating the home beverage experience through design and technology.
            </p>
          </div>
          
          <div>
            <h3 className="font-bold mb-6 text-sm uppercase tracking-wider">Explore</h3>
          ...
          <div>
            <h3 className="font-bold mb-6 text-sm uppercase tracking-wider">Stay Updated</h3>
            <p className="text-zinc-500 text-sm mb-4">Subscribe for exclusive drops and cocktail recipes.</p>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-zinc-600">© 2026 COCKELITO. All rights reserved.</p>
